...
export default function SettingsPage() {
  ...
  > = {
    Personal: [
      ...
      { fieldName: 'Father Name', fieldType: 'text', required: false },
      { fieldName: 'Mother Name', fieldType: 'text', required: false },
      ...
      { fieldName: 'Image', fieldType: 'file', required: false },
    ],
    Education: [
      { fieldName: '10th', fieldType: 'text', required: true },
      { fieldName: '12th', fieldType: 'text', required: true },
      { fieldName: 'Year of Passing', fieldType: 'number', required: true },
      { fieldName: 'Percentage', fieldType: 'number', required: true },
      { fieldName: 'Course', fieldType: 'text', required: true },
    ],
  }
