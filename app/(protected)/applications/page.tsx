...
import { Eye, Plus, Pencil, Trash2, FileDown, FileText } from "lucide-react";
  ...
  const columns = [
    {
      ...
      render: (a: any) => {
        ...
        return a.applicationId ? a.applicationId.toUpperCase() : "—";
      },
    },

    {
      ...
      render: (a: any) => {
        ...
        return a.institute?.name || a.instituteId || "—";
      },
    },
