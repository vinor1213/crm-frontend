...
import { Building2, FileStack, Users2 } from "lucide-react";
import {
  LineChart,
  Line,
  XAxis,
...
export default function DashboardPage() {
  ...
  // 📈 Dummy Lead Data
  const leadData = [
    { name: "Follow Up", value: 1300 },
    { name: "Not Interested", value: 1100 },
      ...
      {loading ? (
        ...
        <>
          ...
          {(userRole === "superadmin" || userpermission?.view) && (
            <>
              <div
                className={`grid grid-cols-1 sm:grid-cols-2 ${userRole === "superadmin" ? "lg:grid-cols-3" : "lg:grid-cols-2"
                  } gap-4 sm:gap-6`}
              >
